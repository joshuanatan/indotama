...
class M_pembelian extends CI_Model{
    ...
    private $pem_tgl;
    private $pem_tgl_bayar;
    private $pem_jenis_bayar;
    private $pem_status_bayar;
    private $pem_totalall;
    private $pem_supp_name;
    private $pem_jmlh_item;
    private $pem_status;
    private $id_fk_supp;
    private $id_fk_toko;
    ...
    public function install(){
        ...
        CREATE TABLE MSTR_PEMBELIAN(
            ...
            PEM_TGL DATE,
            PEM_TGL_BAYAR INT, 
            PEM_JENIS_BAYAR VARCHAR(15),
            PEM_STATUS_BAYAR VARCHAR(15),
            PEM_TOTALALL INT,
            PEM_SUPP_NAME VARCHAR(100),
            PEM_JMLH_ITEM DOUBLE,
