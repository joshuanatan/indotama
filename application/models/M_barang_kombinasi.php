  ...
  public function insert()
  {
    if ($this->check_insert()) {
      if ($this->check_double_barang()) {
        ...
        $log_all_data_changes = "[ID Barang Kombinasi: $id_hasil_insert][ID Barang Utama: $this->id_barang_utama][ID Barang Kombinasi: $this->id_barang_kombinasi][Jumlah: $this->barang_kombinasi_qty][Status: $this->barang_kombinasi_status][Waktu Ditambahkan: $this->barang_kombinasi_create_date][Oleh: $this->id_create_data]";
        $log_all_it = "";
