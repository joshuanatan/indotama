...
class M_cabang_admin extends ci_model
{
  ...
  public function insert()
  {
    if ($this->check_insert()) {
      ...
      $log_all_msg = "Data Admin Cabang baru ditambahkan. Waktu penambahan: $this->cabang_admin_create_date";
      $nama_user = get1Value("mstr_user", "user_name", array("id_pk_user" => $this->id_last_modified));

      $log_all_data_changes = "[ID Admin Cabang: $id_hasil_insert][ID Cabang: $this->id_fk_cabang][ID User: $this->id_fk_user][Status: $this->cabang_admin_status][Waktu Ditambahkan: $this->cabang_admin_create_date][Oleh: $nama_user]";
      $log_all_it = "";
      $log_all_user = $this->id_last_modified;
      $log_all_tgl = $this->cabang_admin_create_date;
  ...
  public function set_insert($id_fk_cabang, $id_fk_user, $cabang_admin_status)
  {
    ...
    $this->set_cabang_admin_status($cabang_admin_status);
    return true;
  }
  public function set_update($id_pk_cabang_admin, $id_fk_cabang, $id_fk_user)
  {
    $this->set_id_pk_cabang_admin($id_pk_cabang_admin);
    $this->set_id_fk_cabang($id_fk_cabang);
    $this->set_id_fk_user($id_fk_user);
    return true;
  }
