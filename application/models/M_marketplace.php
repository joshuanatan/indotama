...
class M_marketplace extends ci_model
{
  ...
  public function insert()
  {
    if ($this->check_insert()) {
      ...
      $log_all_data_changes = "[ID Marketplace: $id_hasil_insert][Nama: $this->marketplace_nama][Keterangan: $this->marketplace_ket][Status: $this->marketplace_status][Biaya: $this->marketplace_biaya][Waktu Ditambahkan: $this->marketplace_create_date][Foto NPWP: $nama_user]";
      $log_all_it = "";
