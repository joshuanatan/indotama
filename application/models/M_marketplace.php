...
class M_marketplace extends ci_model
{
  ...
  public function insert()
  {
    if ($this->check_insert()) {
      ...
      $log_all_msg = "Data Marketplace baru ditambahkan. Waktu penambahan: $this->marketplace_create_date";
      $nama_user = get1Value("mstr_user", "user_name", array("id_pk_user" => $this->id_create_data));

      $log_all_data_changes = "[ID Marketplace: $id_hasil_insert][Nama: $this->marketplace_nama][Keterangan: $this->marketplace_ket][Status: $this->marketplace_status][Biaya: $this->marketplace_biaya][Waktu Ditambahkan: $this->marketplace_create_date][Oleh: $nama_user]";
      $log_all_it = "";
      $log_all_user = $this->id_create_data;
      $log_all_tgl = $this->marketplace_create_date;
  ...
  public function update()
  {
    if ($this->check_update()) {
      ...
      if (!isExistsInTable($this->tbl_name, $where)) {
        ...
        $id_pk = $this->id_pk_marketplace;
        $log_all_msg = "Data Marketplace dengan ID: $id_pk diubah. Waktu diubah: $this->marketplace_last_modified . Data berubah menjadi: ";
        $nama_user = get1Value("mstr_user", "user_name", array("id_pk_user" => $this->id_last_modified));

        $log_all_data_changes = "[ID Marketplace: $id_pk][Nama: $this->marketplace_nama][Keterangan: $this->marketplace_ket][Biaya: $this->marketplace_biaya][Waktu Diubah: $this->marketplace_create_date][Oleh: $nama_user]";
        $log_all_it = "";
        $log_all_user = $this->id_last_modified;
        $log_all_tgl = $this->marketplace_last_modified;
