...
class M_penjualan_online extends ci_model
{
  ...
  public function insert($penj_on_marketplace, $penj_on_no_resi, $penj_on_kurir, $penj_on_status, $id_fk_penjualan)
  {
    $data = array(
      "penj_on_marketplace" => $penj_on_marketplace,
      "penj_on_no_resi" => $penj_on_no_resi,
      "penj_on_kurir" => $penj_on_kurir,
      "penj_on_status" => $penj_on_status,
