...
class M_barang_kantor extends ci_model
{
  ...
  public function content($page = 1, $order_by = 0, $order_direction = "asc", $search_key = "", $data_per_page = "")
  {
    ...
    $query = "
        select id_pk_brg,brg_kode,brg_nama,brg_ket,brg_minimal,brg_status,brg_satuan,brg_image,brg_last_modified,brg_merk_nama,brg_jenis_nama,brg_tipe
        from " . $this->tbl_name . " 
        ...
        where brg_status = 'aktif' and (brg_jenis_status = 'aktif' or brg_jenis_status is null) and (brg_merk_status = 'aktif' or brg_merk_status is null) and id_pk_brg_jenis = 0 " . $search_query . " 
  ...
  {
    $sql = "select id_pk_brg,brg_kode,brg_nama,brg_ket,brg_minimal,brg_status,brg_satuan,brg_image,brg_last_modified,brg_merk_nama,brg_jenis_nama,brg_tipe
        from " . $this->tbl_name . " 
        ...
        where brg_status = 'aktif' and brg_jenis_status = 'aktif' and brg_merk_status = 'aktif' and brg_nama = ?
  ...
  public function detail_by_id()
  {
    $sql = "select id_pk_brg,brg_kode,brg_nama,brg_ket,brg_minimal,brg_status,brg_satuan,brg_image,brg_harga,brg_harga_toko,brg_harga_grosir,brg_last_modified,brg_merk_nama,brg_jenis_nama,brg_tipe
        ...
        inner join mstr_barang_jenis on mstr_barang_jenis.id_pk_brg_jenis = " . $this->tbl_name . ".id_fk_brg_jenis
        inner join mstr_barang_merk on mstr_barang_merk.id_pk_brg_merk = " . $this->tbl_name . ".id_fk_brg_merk
        where brg_status = 'aktif' and brg_jenis_status = 'aktif' and brg_merk_status = 'aktif' and id_pk_brg = ?
        group by id_pk_brg 
        order by brg_nama asc";
    $args = array(
      $this->id_pk_brg
  ...
  public function update()
  {
    if ($this->check_update()) {
      ...
      $id_pk = $this->id_pk_brg;
      $log_all_msg = "Data Barang dengan ID: $id_pk diubah. Waktu diubah: $this->brg_last_modified . Data berubah menjadi: ";
      $nama_user = get1Value("mstr_user", "user_name", array("id_pk_user" => $this->id_last_modified));

      $log_all_data_changes = "[ID Barang: $id_pk][Kode: $this->brg_kode][Nama: $this->brg_nama][Keterangan: $this->brg_ket][Minimal: $this->brg_minimal][Status: $this->brg_status][Satuan: $this->brg_satuan][File Gambar: $this->brg_image][Harga Satuan: $this->brg_harga][Harga Toko: $this->brg_harga_toko][Harga Grosir: $this->brg_harga_grosir][Tipe: $this->brg_tipe][ID Jenis Barang: $this->id_fk_brg_jenis][ID Merek Barang: $this->id_fk_brg_merk][Waktu Diubah: $this->brg_last_modified][Oleh: $nama_user]";
      $log_all_it = "";
      $log_all_user = $this->id_last_modified;
      $log_all_tgl = $this->brg_last_modified;
  ...
  public function data_excel()
  {
    $sql = "select id_pk_brg,brg_kode,brg_nama,brg_ket,brg_minimal,brg_status,brg_satuan,brg_image,brg_harga,brg_harga_toko,brg_harga_grosir,brg_last_modified,brg_merk_nama,brg_jenis_nama,brg_tipe
        ...
        inner join mstr_barang_jenis on mstr_barang_jenis.id_pk_brg_jenis = " . $this->tbl_name . ".id_fk_brg_jenis
        inner join mstr_barang_merk on mstr_barang_merk.id_pk_brg_merk = " . $this->tbl_name . ".id_fk_brg_merk
        where brg_status = 'aktif' and brg_jenis_status = 'aktif' and brg_merk_status = 'aktif'  
        group by id_pk_brg 
        order by brg_nama asc";
