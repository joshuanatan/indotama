...
class Invoice extends CI_Controller{
    ...
    public function index($id_pk_penjualan){
        ...
        $cek_tambahan = selectRow("tbl_tambahan_penjualan",$where)->result_array();
        if(count($cek_tambahan)>0){
            ...
            $data['penjualan_brg_tambahan'] = executeQuery("SELECT * FROM mstr_penjualan join tbl_tambahan_penjualan on mstr_penjualan.id_pk_penjualan = tbl_tambahan_penjualan.id_fk_penjualan WHERE mstr_penjualan.id_pk_penjualan='$id_pk_penjualan'")->result_array();
