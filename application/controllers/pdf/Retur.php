...
class Retur extends CI_Controller{
    ...
    public function index($id_pk_retur){
        ...
        $data['retur_barang'] = executeQuery("SELECT * FROM mstr_retur join tbl_retur_brg on mstr_retur.id_pk_retur = tbl_retur_brg.id_fk_retur join mstr_barang on mstr_barang.id_pk_brg = tbl_retur_brg.id_fk_brg WHERE mstr_retur.id_pk_retur = '$id_pk_retur'")->result_array();
