          ...
          for (var a = 0; a < respond["content"].length; a++) {
            ...
            html += `
              <td class = 'align-middle text-center action_column'>
                ...
                <a href = "<?php echo base_url(); ?>toko/brg_cabang_toko/${respond["content"][a]["id"]}" target = "_blank"><i style = 'cursor:pointer;font-size:large' class = 'text-success md-store'></i></a>
                <a href = "<?php echo base_url(); ?>toko/admin_cabang_toko/${respond["content"][a]["id"]}" target = "_blank"><i style = 'cursor:pointer;font-size:large' class = 'text-warning md-assignment-account'></i></a>
              </td>`;
            html += "</tr>";
          }
        } else {
