          ...
          for (var a = 0; a < respond["content"].length; a++) {
            ...
            html += `
              <td class = 'align-middle text-center action_column'>
                ...
                <a href = "<?php echo base_url(); ?>toko/warehouse/${respond["content"][a]["id"]}"><i style = 'cursor:pointer;font-size:large' data-toggle = 'modal' class = 'text-primary md-store'></i></a>
                <a href = "<?php echo base_url(); ?>toko/brg_cabang/${respond["content"][a]["id"]}"><i style = 'cursor:pointer;font-size:large' data-toggle = 'modal' class = 'text-success md-store'></i></a>
                <a href = "<?php echo base_url(); ?>toko/admin_cabang/${respond["content"][a]["id"]}"><i style = 'cursor:pointer;font-size:large' data-toggle = 'modal' class = 'text-warning md-assignment-account'></i></a>
              </td>`;
            html += "</tr>";
          }
        } else {
