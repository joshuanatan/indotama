        ...
        <div class = "modal-content">
            ...
            <div class = "modal-body">
                    <div class = "form-group">
                        <h5>Kode Barang</h5>
                        <input disabled type = 'text' class = 'form-control' name = 'brg' id = "d_brg_kode">
                    </div>
                    <div class = "form-group">
                        <h5>Nama Barang</h5>
                        <input disabled type = 'text' class = 'form-control' name = 'brg' id = "d_nama_brg">
                    </div>
                    <div class = "form-group">
                        <h5>Gambar Barang</h5>
                        <img width="200px" id = "d_gbr_brg">
                    </div>
                    <div class = "form-group">
                        <h5>Stok</h5>
