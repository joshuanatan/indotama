              ...
              <div class="panel-wrapper collapse in">
                <div class="panel-body">
                  <div class="col-lg-12">
                    ...
                    <?php
                    $data = array(
                      "ctrl_model" => "m_pembelian",
                      "excel_title" => "Daftar Pembelian"
                    );
                    ?>
          ...
          for (var a = 0; a < respond["content"].length; a++) {
            ...
            html += `
              <td class = 'align-middle text-center action_column'>
                ...
                <a style = 'font-size:large' data-toggle = "modal" data-target = "#selesai_modal" onclick = "load_selesai_content(${a})"><i class = 'text-secondary md-check'></i></a>
                <a style = 'font-size:large' href = "<?php echo base_url(); ?>pdf/pembelian/index/${respond["content"][a]["id"]}" target = "_blank"><i class = 'text-info md-print'></i></a>
              </td>`;
            html += "</tr>";
          }
        } else {
