<?php $base_url = "http://localhost/indotama"; ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="UTF-8" />
		...
		<div class="wrapper error-page pa-0">
			<header class="sp-header">
				...
				<div class="form-group mb-0 pull-right">
					<a class="inline-block btn btn-primary btn-rounded btn-outline nonecase-font" href="<?php echo $base_url; ?>/2938c7f7e560ed972f8a4f68e80ff834">Back to Home</a>
				</div>
