    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="register_form" method="POST">
          ...
          <input type='hidden' name='tipe_pengiriman' value='retur'>
          <input type='hidden' name='id_tempat_pengiriman' value='<?php echo $id_tempat_pengiriman; ?>'>
          <div class="form-group">
            <h5>Nomor Retur</h5>
            <input type="text" class="form-control" list="datalist_retur_confirmed_kembali_barang" required id="no_retur">
          </div>
          <div class="form-group">
          ...
          for (var a = 0; a < respond["content"].length; a++) {
            html += `
                        <tr class = 'brg_retur_row'>
                            ...
                            <td>
                                <input value = "-" type = 'text' class = 'form-control' name = 'notes${a}'>
                            </td>
                            <td>
                                <div style = 'display:inline-block'>
                                    <input type = 'text' class = 'form-control nf-input' style = 'width:50%; display:inline-block' value = 0 name = 'qty_kirim${a}'>
