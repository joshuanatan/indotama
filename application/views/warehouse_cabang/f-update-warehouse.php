        ...
        <div class = "modal-content">
            ...
            $this->load->view('_notification/update_error',$notif_data); ?>
                <form id = "update_form" method = "POST">
                    ...
                    <input type="hidden" class="form-control" name="warehouse_cabang" value="<?php echo $cabang[0]['id_pk_cabang'] ?>" required>
...
<script>
    function load_edit_content(id){
        ...
        if(content[id]["nama_cabang"]=="-not registered-"){
            $('#warehouse_nama_cabang').val("");
        }
        else{
            $('#warehouse_nama_cabang').val(content[id]["nama_cabang"]);
        }
