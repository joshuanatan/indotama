              ...
              <div class="panel-wrapper collapse in">
                <div class="panel-body">
                  <div class="col-lg-12">
                    ...
                    <?php
                    $data = array(
                      "ctrl_model" => "m_supplier",
                      "excel_title" => "Daftar Supplier"
                    );
                    ?>
          ...
          for (var a = 0; a < respond["content"].length; a++) {
            ...
            html += `
              <tr>
                  ...
                  <td>
                      <a style = 'cursor:pointer;font-size:large' class = 'detail_button text-success md-eye' href = '<?php echo base_url();?>supplier/detail/${respond["content"][a]["id"]}' target = "_blank" ></a>
