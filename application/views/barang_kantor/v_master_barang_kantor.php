              ...
              <div class="panel panel-default card-view">
                ...
                <div class="panel-wrapper collapse in">
                  <div class="panel-body">
                    ...
                    <div class="col-lg-12">
                      <div class="d-flex">
                        <button id="tambah_kantor" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#register_modal" style="margin-bottom:10px;margin-right:10px">Tambah Barang Kantor</button>
                      </div>
...
<?php
$data = array(
  "page_title" => "Master Barang Kantor"
);
?>
<?php $this->load->view("barang_kantor/f-add-barang-kantor", $data); ?>
<?php $this->load->view("barang_kantor/f-update-barang-kantor", $data); ?>
<?php $this->load->view("barang_kantor/f-delete-barang-kantor", $data); ?>
<?php $this->load->view("_base_element/datalist_barang_merk"); ?>
<?php $this->load->view("_base_element/datalist_satuan"); ?>
<?php $this->load->view('_notification/notif_general'); ?>
<?php $this->load->view("req/core_script"); ?>
<script>
  var ctrl = "barang_kantor";
