    ...
    <table>
        <tr>
            ...
            <td style="text-align:right">
                ...
                '.$pengiriman_main_kepada[0]['cabang_nama'].'<br>
                '.$pengiriman_main_kepada[0]['cabang_alamat'].'
                <br><br>
                '.$pengiriman_main_kepada[0]['cabang_notelp'].'
            </td>
        </tr>
        <tr>
            <td colspan="2" style="line-height:25px"><b>SURAT JALAN No. '.$pengiriman_main_dari[0]['pengiriman_no'].'</b></td>
        </tr>
        <tr>
            <td></td>
        </tr>
