...
<script src="<?php echo base_url(); ?>vendors/bower_components/simpleWeather/jquery.simpleWeather.min.js">
</script>
...
<!-- Toast JavaScript -->
<script src="<?php echo base_url(); ?>vendors/bower_components/jquery-toast-plugin/dist/jquery.toast.min.js">
</script>

<!-- Bootstrap Select JavaScript -->
<script src="<?php echo base_url(); ?>vendors/bower_components/bootstrap-select/dist/js/bootstrap-select.min.js">
</script>
...
<script src="<?php echo base_url(); ?>vendors/bower_components/Flot/excanvas.min.js"></script>
<script src="<?php echo base_url(); ?>vendors/bower_components/Flot/jquery.flot.js"></script>
<script src="<?php echo base_url(); ?>vendors/bower_components/Flot/jquery.flot.pie.js"></script>
<script src="<?php echo base_url(); ?>vendors/bower_components/Flot/jquery.flot.resize.js"></script>
<script src="<?php echo base_url(); ?>vendors/bower_components/Flot/jquery.flot.time.js"></script>
<script src="<?php echo base_url(); ?>vendors/bower_components/Flot/jquery.flot.stack.js"></script>
<script src="<?php echo base_url(); ?>vendors/bower_components/Flot/jquery.flot.crosshair.js"></script>
<script src="<?php echo base_url(); ?>vendors/bower_components/flot.tooltip/js/jquery.flot.tooltip.min.js">
</script>
