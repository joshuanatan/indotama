...
?>
  ...
  if ($this->session->id_warehouse) : ?>
    <li class="navigation-header">
      <span><?php echo ucwords(strtolower($this->session->nama_toko)); ?> - <?php echo ucwords(strtolower($this->session->nama_cabang)); ?> - <?php echo ucwords(strtolower($this->session->nama_warehouse)); ?></span>
