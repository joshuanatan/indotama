<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="mobile-only-brand pull-left">
        ...
        <a href="penjualan.php" class="btn btn-success btn-anim" style="margin-top:10px !important; margin-left:10px"><i
                class="fa fa-shopping-bag"></i><span class="btn-text">PENJUALAN</span></a>
        <a href="pembelian.php" class="btn btn-info btn-anim" style="margin-top:10px !important;margin-left:10px"><i
                class="fa fa-shopping-bag"></i><span class="btn-text">PEMBELIAN</span></a>
    </div>
