        ...
        <tr class = 'add_brg_kembali_row'>
            ...
            <td style = "width:30%">
              <table>
                <tr>
                  <td>Harga Satuan</td>
                  <td style = "padding:0px 5px" id = 'harga_barang_jual${brg_kembali_row}'></td>
                </tr>
                <tr>
                  <td>Harga Toko</td>
                  <td style = "padding:0px 5px" id = 'harga_barang_toko${brg_kembali_row}'></td>
                </tr>
                <tr>
                  <td>Harga Grosir</td>
                  <td style = "padding:0px 5px" id = 'harga_barang_grosir${brg_kembali_row}'></td>
                </tr>
              </table>
            </td>
            <td>
