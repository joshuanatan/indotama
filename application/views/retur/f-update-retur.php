...
<script>
        ...
        success: function(respond) {
          ...
          if (respond["status"] == "SUCCESS") {
            ...
            for (var a = 0; a < respond["content"].length; a++) {
              html += `
                            <tr class = 'brg_kembali_row_edit'>
                                <td id = 'brg_kembali_row_edit${a}'>
                                    ...
                                    <input type = 'text' list = 'datalist_barang_cabang_jualan' onchange = 'load_harga_barang_edit(${a})' value = '${respond["content"][a]["nama_brg"]}'id = 'brg${a}' name = 'brg_edit${a}' class = 'form-control'>
                                </td>
                                <td>
                                ...
                                <td style = "width:30%">
                                  <table>
                                    <tr>
                                      <td>Harga Satuan</td>
                                      <td style = "padding:0px 5px" id = 'harga_barang_jual_edit${a}'></td>
                                    </tr>
                                    <tr>
                                      <td>Harga Toko</td>
                                      <td style = "padding:0px 5px" id = 'harga_barang_toko_edit${a}'></td>
                                    </tr>
                                    <tr>
                                      <td>Harga Grosir</td>
                                      <td style = "padding:0px 5px" id = 'harga_barang_grosir_edit${a}'></td>
                                    </tr>
                                  </table>
                                </td>
                                <td>
              ...
              $("#add_brg_kembali_but_container_edit").before(html); /*terpaksa diubah di dalem loop untuk bisa ngeload barang msg2*/
              load_harga_barang_edit(a);
              html = "";
            }
            init_nf();
  ...
  function add_brg_kembali_edit() {
    var brg_kembali_row = $(".brg_kembali_row_edit").length;
    var html = `
        <tr class = 'brg_kembali_row_edit add_brg_kembali_row'>
            <td id = 'brg_kembali_counter${brg_kembali_row}'>
                <input name = 'brg_kembali_check[]' value = ${brg_kembali_row} type = 'hidden'>
                <input type = 'text' list = 'datalist_barang_cabang_jualan' onchange = 'load_harga_barang_edit(${brg_kembali_row})' id = 'brg${brg_kembali_row}' name = 'brg${brg_kembali_row}' class = 'form-control'>
            </td>
            <td>
            ...
            <td style = "width:30%">
              <table>
                <tr>
                  <td>Harga Satuan</td>
                  <td style = "padding:0px 5px" id = 'harga_barang_jual_edit${brg_kembali_row}'></td>
                </tr>
                <tr>
                  <td>Harga Toko</td>
                  <td style = "padding:0px 5px" id = 'harga_barang_toko_edit${brg_kembali_row}'></td>
                </tr>
                <tr>
                  <td>Harga Grosir</td>
                  <td style = "padding:0px 5px" id = 'harga_barang_grosir_edit${brg_kembali_row}'></td>
                </tr>
              </table>
            </td>
            <td>
  ...
  function load_harga_barang_edit(row) {
    ...
    $("#harga_barang_jual_edit" + row).text(`Rp. ${format_number(hrg_brg_dsr)}`);
    $("#harga_barang_toko_edit" + row).text(`Rp. ${format_number(hrg_brgtoko)}`);
    $("#harga_barang_grosir_edit" + row).text(`Rp. ${format_number(hrg_brggrosir)}`);
