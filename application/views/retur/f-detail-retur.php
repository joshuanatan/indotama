        ...
        <div class = "modal-content">
            ...
            <div class = "modal-body">
                    ...
                    <div class = "form-group">
                        <h5>Nomor Retur</h5>
                        <input type = "text" class = "form-control" list = "datalist_penjualan" required id = "d_no_retur_edit" name = "no_retur">
                    </div>
                    <div class = "form-group">
                        <h5>Nomor Penjualan</h5>
                        <input type = "text" class = "form-control" readonly required id = "d_no_penjualan_edit">
                    </div>
                    <div class = "form-group">
                        <h5>Tanggal Retur</h5>
                        <input type = "date" class = "form-control" required id = "d_tgl_retur_edit" name = "tgl_retur">
                    </div>
                    <div class = "form-group">
                        <h5>Barang Retur</h5>
