              ...
              <div class="panel-wrapper collapse in">
                <div class="panel-body">
                  <div class="col-lg-12">
                    ...
                    <?php
                    $data = array(
                      "ctrl_model" => "m_brg_permintaan",
                      "excel_title" => "Daftar Permintaan barang"
                    );
                    ?>
          ...
          for (var a = 0; a < respond["content"].length; a++) {
            ...
            html += `
              <td class = 'align-middle text-center action_column'>
                ...
                <i style = 'cursor:pointer;font-size:large' data-toggle = 'modal' class = 'text-success md-check' data-target = '#selesai_modal' onclick = 'open_konfirmasi_selesai_modal()'></i>
              </td>`;
            html += "</tr>";
          }
        } else {
