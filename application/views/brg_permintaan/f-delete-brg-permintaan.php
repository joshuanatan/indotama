            ...
            $this->load->view('_notification/delete_error',$notif_data); ?>
                ...
                <table class = "table table-bordered table-striped table-hover">
                    <tbody>
                        ...
                        <tr>
                            <th>Deadline Permintaan</th>
                            <td id = "brg_permintaan_deadline_delete"></td>    
                        </tr>
                        <tr>
...
<script>
    function load_delete_content(row){
        ...
        $("#brg_permintaan_deadline_delete").html(content[row]["deadline"]);
        $("#brg_permintaan_status_delete").html(content[row]["status"]);
        $("#brg_nama_delete").html(content[row]["barang"]);
        $("#cabang_daerah_delete").html(content[row]["nama_cabang"]);
    }
</script>