                ...
                if(respond["status"].toLowerCase() == "success"){
                    for(var a = 0; a<respond["content"].length; a++){
                        ...
                        <tr>
                            ...
                            <td>${respond["content"][a]["qty"]} ${respond["content"][a]["satuan"]}</td>
                            <td>${respond["content"][a]["qty_mu"]} ${respond["content"][a]["satuan_mu"]}</td>
                            <td>${respond["content"][a]["harga_stok"]}</td>
                            <td>${respond["content"][a]["harga"]}</td>
                            <td>${respond["content"][a]["note"]}</td>
                        </tr>`;
                        total += respond["content"][a]["qty_mu"]*respond["content"][a]["harga"];
                    }
                ...
                if(respond["status"].toLowerCase() == "success"){
                    for(var a = 0; a<respond["content"].length; a++){
                        ...
                        <tr>
                            ...
                            <td>${respond["content"][a]["jumlah"]} ${respond["content"][a]["satuan"]}</td>
                            <td>${respond["content"][a]["harga"]} Pcs</td>
                            <td>${respond["content"][a]["notes"]} Pcs</td>
                        </tr>`;
                ...
                if(respond["status"].toLowerCase() == "success"){
                    for(var a = 0; a<respond["content"].length; a++){
                        ...
                        <tr>
                            ...
                            <td>${respond["content"][a]["brg_pindah_qty"]} Pcs</td>
                        </tr>`;
                    }
                ...
                if(respond["status"].toLowerCase() == "success"){
                    for(var a = 0; a<respond["content"].length; a++){
                        ...
                        <tr>
                            ...
                            <td>${respond["content"][a]["nominal"]}</td>
