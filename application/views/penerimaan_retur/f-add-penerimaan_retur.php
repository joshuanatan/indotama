...
<script>
    function load_detail_retur(){
        ...
        <?php endfor;?>
        $.ajax({
            url:"<?php echo base_url();?>ws/retur/brg_retur?id_retur="+detail_retur[0]["id"],
            type:"GET",
            async:false,
            dataType:"JSON",
            success:function(respond){
