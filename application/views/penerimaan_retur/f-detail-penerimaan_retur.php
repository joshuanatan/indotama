        ...
        <div class = "modal-content">
            ...
            $notif_data = array(
                ...
                <div class = "form-group col-lg-6">
                    <h5>Nomor Retur</h5>
                    <input type = "text" class = "form-control" list = "datalist_retur" required id = "d_no_retur_edit" readonly>
                </div>
                <div class = "form-group col-lg-6">
                    <h5>Tanggal Penerimaan</h5>
                    <input type = "date" class = "form-control" required name = "tgl_penerimaan" id = "d_tgl_penerimaan_edit">
                </div>
...
<script>
    function load_detail_content(row){
            ...
            success:function(respond){
                ...
                if(respond["status"] == "SUCCESS"){
                    ...
                    for(var a = 0; a<respond["content"].length; a++){
                        html += `
                        <tr class = 'd_brg_pembelian_row_edit'>
        ...
        $("#detail_modal input").attr("disabled",true);
        $("#detail_modal select").attr("disabled",true);
    }
</script>