    				...
    				<div class="row">
    					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    										...
    										<div class="container-fluid">
    											<div class="row">
    												<div class="col-xs-6 text-left pl-0 pr-0 data-wrap-left">
    													...
    													<span class="block"><span class="weight-500 uppercase-font txt-light font-13">Stok Saat Ini</span><i class="zmdi zmdi-caret-down txt-danger font-21 ml-5 vertical-align-middle"></i></span>
    												</div>
                          ...
                          <div class="row">
    												<div class="col-xs-6 text-left pl-0 pr-0 data-wrap-left">
    													<span class="txt-light block counter"><span>LAPORAN</span></span>
    													<span class="block"><span class="weight-500 uppercase-font txt-light font-13">Ringkasan Stok</span><i class="zmdi zmdi-caret-down txt-danger font-21 ml-5 vertical-align-middle"></i></span>
    												</div>
                            <div class="col-xs-6 text-left  pl-0 pr-0 pt-25 data-wrap-right">
													        <a href="#"><button class="btn btn-warning btn-anim pull-right" style="margin-right:30px !important"><i class="fa fa-eye"></i><span class="btn-text">Lihat Laporan</span></button></a>
												    </div>
    				...
    				<div class="row">
    					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <div class="row">
                            <div class="col-xs-6 text-left pl-0 pr-0 data-wrap-left">
                              <span class="txt-light block counter"><span>LAPORAN</span></span>
                              <span class="block"><span class="weight-500 uppercase-font txt-light font-13">Analisis Stok</span><i class="zmdi zmdi-caret-down txt-danger font-21 ml-5 vertical-align-middle"></i></span>
                            </div>
                            <div class="col-xs-6 text-left  pl-0 pr-0 pt-25 data-wrap-right">
                                  <a href="#"><button class="btn btn-warning btn-anim pull-right" style="margin-right:30px !important"><i class="fa fa-eye"></i><span class="btn-text">Lihat Laporan</span></button></a>
                            </div>
