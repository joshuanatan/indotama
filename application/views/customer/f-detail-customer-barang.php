...
<script>
  var ctrl = "customer";
  var tblHeaderCtrl = "columns_detail_brg_penjualan";
  var contentCtrl = "detail_brg_penjualan";
        ...
        if (respond["status"] == "SUCCESS") {
          ...
          for (var a = 0; a < respond["content"].length; a++) {
            ...
            <tr>
                ...
                <td>${respond["content"][a]["brg_penjualan_qty"]} ${respond["content"][a]["brg_penjualan_satuan"]}</td>
                <td>${respond["content"][a]["brg_penjualan_harga"]}</td>
