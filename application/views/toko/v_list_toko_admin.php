...
<script>
  ...
  var page = 1;
  var content = [];
  var contentCtrl = "list_toko_admin";
  var tblHeaderCtrl = "columns_toko_admin";
          ...
          for (var a = 0; a < respond["content"].length; a++) {
            ...
            html += `
              <td class = 'align-middle text-center action_column'>
                <a href = "<?php echo base_url(); ?>toko/activate_toko_manajemen/${respond["content"][a]["id"]}"><i style = 'cursor:pointer;font-size:large' class = 'md-wrench'></i></a>
              </td>`;
            html += "</tr>";
          }
        } else {
