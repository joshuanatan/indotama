                                ...
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        <div class = "col-lg-12">
                                            ...
                                            <?php
                                                $data = array(
                                                    "ctrl_model" => "m_employee",
                                                    "excel_title" => "Daftar Employee"
                                                );
                                            ?>
            ...
            success: function(respond) {
                if(respond["status"] == "SUCCESS"){
                    ...
                    for(var a = 0; a<respond["content"].length; a++){
                        ...
                        html += `
                            <tr>
                                <td>${respond["content"][a]["foto"]}</td>
                                <td>${respond["content"][a]["nama"]}</td>
                                <td>${respond["content"][a]["ktp"]}</td>
                                <td>${respond["content"][a]["npwp"]}</td>
                                <td>${respond["content"][a]["hp"]}</td>
                                <td>${respond["content"][a]["alamat"]}</td>
                                <td>${respond["content"][a]["gender"]}</td>
                                ${html_status}
