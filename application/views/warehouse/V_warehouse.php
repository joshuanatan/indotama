            ...
            html += `
              <tr>
                ...
                <td>
                    ...
                    <a href = "<?php echo base_url(); ?>warehouse/brg_warehouse/${respond["content"][a]["id"]}"><i class = 'text-success md-store'></i></a>
                    <a href = "<?php echo base_url(); ?>warehouse/admin/${respond["content"][a]["id"]}"><i class = 'text-warning md-assignment-account'></i></a>
                </td>
            </tr>
        `;
          }
