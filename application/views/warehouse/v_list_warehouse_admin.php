...
<script>
  var ctrl = "warehouse";
  var url_add = "";
  var contentCtrl = "list_gudang_admin";
          ...
          for (var a = 0; a < respond["content"].length; a++) {
            ...
            html += `
              <td class = 'align-middle text-center action_column'>
                <a href = "<?php echo base_url(); ?>warehouse/activate_warehouse_manajemen/${respond["content"][a]["id"]}"><i style = 'cursor:pointer;font-size:large' class = 'md-wrench'></i></a> 
              </td>`;
            html += "</tr>";
          }
        } else {
