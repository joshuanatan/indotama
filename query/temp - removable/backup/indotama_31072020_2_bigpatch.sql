...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2020 at 01:44 PM
...
(2, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@email.com2', 'AKTIF', 1, 1, '2020-07-14 09:59:42', '2020-07-14 09:53:58', 1, 1);
...
CREATE TRIGGER `trg_after_insert_warehouse` AFTER INSERT ON `mstr_warehouse` FOR EACH ROW begin
            ...
            set @log_data = concat('','[id_pk_warehouse: ',new.id_pk_warehouse,']','[warehouse_nama: ',new.warehouse_nama,']','[warehouse_alamat: ',new.warehouse_alamat,']','[warehouse_notelp: ',new.warehouse_notelp,']','[warehouse_desc: ',new.warehouse_desc,']','[warehouse_status: ',new.warehouse_status,']','[warehouse_create_date: ',new.warehouse_create_date,']','[warehouse_last_modified: ',new.warehouse_last_modified,']','[id_create_data: ',new.id_create_data,']','[id_last_modified: ',new.id_last_modified,']');
            call insert_log_all(new.id_last_modified,@log_msg,@log_data,@log_it);
        end
$$
DELIMITER ;
...
CREATE TRIGGER `trg_after_update_warehouse` AFTER UPDATE ON `mstr_warehouse` FOR EACH ROW begin
            ...
            set @log_it = concat('Refrensi log table mstr_warehouse_log dengan id_pk_warehouse_log ',@last_id);
            set @log_data = concat('','[id_pk_warehouse: ',old.id_pk_warehouse,' => ',new.id_pk_warehouse,']','[warehouse_nama: ',old.warehouse_nama,' => ',new.warehouse_nama,']','[warehouse_alamat: ',old.warehouse_alamat,' => ',new.warehouse_alamat,']','[warehouse_notelp: ',old.warehouse_notelp,' => ',new.warehouse_notelp,']','[warehouse_desc: ',old.warehouse_desc,' => ',new.warehouse_desc,']','[warehouse_status: ',old.warehouse_status,' => ',new.warehouse_status,']','[warehouse_create_date: ',old.warehouse_create_date,' => ',new.warehouse_create_date,']','[warehouse_last_modified: ',old.warehouse_last_modified,' => ',new.warehouse_last_modified,']','[id_create_data: ',old.id_create_data,' => ',new.id_create_data,']','[id_last_modified: ',old.id_last_modified,' => ',new.id_last_modified,']');
            call insert_log_all(new.id_last_modified,@log_msg,@log_data,@log_it);
        end
$$
DELIMITER ;
...
--
ALTER TABLE `log_all`
  MODIFY `id_pk_log_all` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `tbl_brg_warehouse`
  MODIFY `id_pk_brg_warehouse` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
